 ...
 *
 * A public install can end up with `origin=git@github.com:AetherMesh-AI/Eidolon.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/AetherMesh-AI/Eidolon.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/aethermesh-ai/eidolon'
