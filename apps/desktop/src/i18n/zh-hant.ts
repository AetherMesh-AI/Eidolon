...
export const zhHant = defineLocale({
  ...
  install: {
    ...
    localStartUnavailable: '無法啟動本機安裝。請重新啟動 Eidolon 後再試一次。',
  ...
  onboarding: {
    headerTitle: '開始設定 Eidolon',
    headerDesc: '連線模型提供方即可開始聊天。大多數選項只需一次點擊。',
    preparingInstall: 'Eidolon 正在完成安裝。首次執行通常不到一分鐘。',
    starting: '正在啟動 Eidolon…',
