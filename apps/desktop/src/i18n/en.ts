...
export const en: Translations = {
  ...
  install: {
    ...
    setupChoiceTitle: 'Set up Eidolon',
    setupChoiceDesc:
    ...
    localStartUnavailable: 'Local installation could not start. Restart Eidolon and try again.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Eidolon",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Eidolon is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Eidolon…',
