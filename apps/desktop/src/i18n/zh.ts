...
export const zh: Translations = {
  ...
  install: {
    ...
    localStartUnavailable: '无法启动本地安装。请重启 Eidolon 后重试。',
  ...
  onboarding: {
    headerTitle: '开始设置 Eidolon',
    headerDesc: '连接模型提供方即可开始对话。大多数选项只需一次点击。',
    preparingInstall: 'Eidolon 正在完成安装。首次运行通常不到一分钟。',
    starting: '正在启动 Eidolon…',
