...
Browser-based dashboard in the Eidolon checkout for managing the underlying Hermes Agent runtime configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking; sidebar also uses `uppercase` | Sidebar/mobile “Eidolon” — uppercase sidebar, mixed-case mobile, no Mondwest, no `text-display` |
