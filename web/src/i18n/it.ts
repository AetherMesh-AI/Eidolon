...
export const it: Translations = {
  ...
  env: {
    ...
    customHint: "Variabili d'ambiente arbitrarie salvate nel tuo .env che Eidolon non riconosce. Usale per iniettare variabili d'ambiente per skill, server MCP o i tuoi strumenti.",
