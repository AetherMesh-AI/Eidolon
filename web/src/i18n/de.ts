...
export const de: Translations = {
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die Eidolon nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
